              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    Text("You currently have no request notification")
                  ],
                ),
              ),
            ),
        ...
        return GestureDetector(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Image.asset(
                  getIconAssetName(service[index]['icon']),
                  width: 24,
                ),
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(
                          text:
                              ' - request from ${service[index]['fullName']} at ',
                          style: TextStyle(
                            color: Colors
                        ...
                        TextSpan(
                          text: '${service[index]['propertyName']}',
                          style: TextStyle(
                            color: Colors
                                .black, // Replace with Pallete.black if defined
                            fontSize: 11,
